...
async def test_websocket() -> NoReturn:
    event_guid = "6ef4b55c-4690-4454-a408-c5a643e4312b"  # Replace with a valid event GUID
    uri: LiteralString = f"ws://localhost:8000/ws/events/{event_guid}"  # Update with your actual URL
